 ...
 * method to extract feature from tv program and tv event.
 * @author Jonathan Bergeron
 *
 * @param <T> The tv program class from which the features will be extracted. 
 * @param <U> The tv event class from which the features will be extracted.
 */
