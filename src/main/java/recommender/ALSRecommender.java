...
/**
 * TODO: finish this class, make it extends the tv recommender class.
 * 
...
public class ALSRecommender {
	...
	public static MatrixFactorizationModel trainExplicit(
			JavaRDD<Rating> ratings, int matrixRank, int numIter) {
	...
	public static MatrixFactorizationModel trainImplicit(
		...
		return ALS.trainImplicit(JavaRDD.toRDD(ratings), matrixRank, numIter,
				lambda, alpha);
	}
