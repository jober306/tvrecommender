...
public class LocalDateTimeIterator implements Iterator<LocalDateTime>, Iterable<LocalDateTime>{
	...
	public LocalDateTimeIterator(LocalDateTime startTime, LocalDateTime endTime, Duration duration) {
